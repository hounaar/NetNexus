...
<div class="container container-portal mt-5">
    <div class="row">
      ...
      <!-- the first content here -->
        ...
        <?php include_once "/opt/lampp/htdocs/src/php/select_profile.php";?>
           </div>
                ...
                <!-- the family content here -->
                    ...
                    <?php include_once "/opt/lampp/htdocs/src/php/family_select.php"; ?>
                    </div>
...
include_once "/opt/lampp/htdocs/src/php/story_select.php";
...
<?php include_once "/opt/lampp/htdocs/src/php/git_insight.php";?>
